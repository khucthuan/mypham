...
?>
    <div class="main">
        ...
        <div class="main__slice">
            <div class="slider">
                <div class="slide active" style="background-image:url(./image/backgr01.PNG)">
                    <div class="container">
                        <div class="caption">
                            <h1>Giảm giá 30%</h1>
                ...
                <div class="slide active" style="background-image:url(./image/backgr.PNG)">
                    <div class="container">
                        <div class="caption">
                            <h1>Giảm giá 30%</h1>
                            <p>Giảm giá cực sốc trong tháng 6!</p>
...
if ( isset($_POST['search']) ) {
  ...
  if($k ==""){
    ...
    if($count < 0){
      ...
      echo "Đã tim thay ket qua voi tu khoa".$k;
                ...
                <div class="grid wide">
                    ...
                    <div class="owl-carousel news owl-theme"> 
                        <?php foreach ($data1 as $row1 => $value) { ?>
                            <a href="tintucchitiet.php?BV_MA=<?= $value['BV_MA'] ?>"class="news">
                                <div class="news__img">
