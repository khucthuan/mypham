...
<div class="container">
        <div class="modal-dialog">
            ...
            <center><h2 class="modal-title" id="editModalLabel">Cập Nhật Loại Hàng</h3>    </center>
            <center> <form action="loaihangcapnhat.php" method="post">
           
           
                            <div class="form-group col-6">
                            <label class="col-form-label font-weight-bold">Mã Loại Hàng</label>
                            <input type="text"  id="L_MA" name="L_MA" class="form-control" value="<?php echo $row['L_MA'];?>">
                        </div>
                        <div class="form-group col-6">
                            <label class="col-form-label font-weight-bold">Tên Loại Hàng</label>
                            <input type="text"  id="L_TEN" name="L_TEN" class="form-control" value="<?php echo $row['L_TEN'];?>">
                        </div>
