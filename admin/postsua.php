       ...
       ?>
        ...
        <?php
                                        if (isset($_POST['btnSave'])) {
                                            ...
                                            $sql = "UPDATE baiviet SET BV_TEN='$BV_TEN', BV_MOTANGAN='$BV_MOTANGAN', BV_NOIDUNG='$BV_NOIDUNG' WHERE BV_MA='$BV_MA';";
                                               ...
                                               <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                        <form action="postcapnhat.php" method="post">
                                                                        <div class="form-group">
                                                                    <label class="col-form-label font-weight-bold">Mã Bài Viết<span class="text-danger"></span></label>
                                                                    <input id="BV_MA" name="BV_MA" type="text" class="form-control" value="<?php echo $Row['BV_MA'] ?>">
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="BV_MOTANGAN" name="BV_MOTANGAN" class="form-control" value="<?php echo $Row['BV_MOTANGAN'] ?>"></input>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="col-form-label font-weight-bold">Nội dung<span class="text-danger"></span></label>
                                                                    <input id="BV_NOIDUNG" name="BV_NOIDUNG" class="form-control" value="<?php echo $Row['BV_NOIDUNG'] ?>"></input>
                                                                </div>
